...
<body>
   ...
   <div>
      <form action="http://localhost:8787/04_HomePage/StudentServlet?cmd=join" method="post">
         <fieldset>
            <legend>Personnel Information</legend>
            <ul>
               <li>ID : <input type="text" name="id" autofocus required
                  placeholder="공백없이 입력하세요"></li>
               <li>PASSWORD : <input type="text" name="passwd" 
                  required placeholder="공백없이 입력하세요"></li>
               <li>USERNAME : <input type="text" name="username" 
                  required placeholder="공백없이 입력하세요"></li>
               <li>STUDENTNUMBER : <input type="text" name="snum" 
                  required placeholder="공백없이 입력하세요"></li>
               <li>DEPARTMENT : <input type="text" name="depart"  placeholder="공백없이 입력하세요"></li>
               <li>MOBILE : <input type="text" name="mobile"  placeholder="***.****.****"></li>
               <li>EMAIL : <input type="text" name="email" placeholder="****@****.***"></li>
            </ul>
         </fieldset>
         <br>
         <fieldset>
