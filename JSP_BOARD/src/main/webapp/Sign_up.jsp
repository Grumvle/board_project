...
<body>
	...
	<div>
		<form name = "fform" action="http://localhost:8787/JSP_BOARD/MemberServlet?cmd=join"
			method="post" onsubmit = "return submitt()">
			<fieldset>
				...
				<ul>
					...
					<li>비밀번호 : <input type="password" name="pwd" id="pwd"
						onchange="check_pw()" required placeholder="공백없이 입력하세요"></li>

					<li>비밀번호 확인: <input type="password" name="pwd_again"
						id="pwd_again" onchange="check_pw()" required
						placeholder="공백없이 입력하세요"><span id="check"></span></li>
					...
					<li>주소 : <input name="addr" type="text" id="postcode"
						...
						<input name="addr1" type="text" id="road_address"
